...
import (
	...
	"github.com/tsuru/nginx-operator/pkg/generated/clientset/versioned/scheme"
...
// NginxV1alpha1Client is used to interact with features provided by the nginx.tsuru.io group.
type NginxV1alpha1Client struct {
	restClient rest.Interface
}

func (c *NginxV1alpha1Client) Nginxes(namespace string) NginxInterface {
