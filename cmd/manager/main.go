...
func main() {
	...
	pflag.StringVar(&configFile, "c", "", "Path to configuration file")
	pflag.DurationVar(&syncPeriod, "sync-period", time.Duration(5*time.Minute), "Time period which the observed resources are reconciled")
